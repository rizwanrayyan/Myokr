...
import AddObjectivesPopup from "../../components/AddObjectivesPopup/AddObjectivesPopup";
...
const ObjectivesList = () => {
  ...
  const [ObjectivesPopup, setObjectivesPopup] = useState(false);
  ...
  return (
    <MainLayout>
      <h1 className="text-2xl font-medium mb-4">Objectives</h1>
      <div className="flex justify-end ">
        <button
          onClick={() => setObjectivesPopup(true)}
      ...
      <div className="overflow-x-auto w-full mt-6">
        ...
        />
        <AddObjectivesPopup
          isOpen={ObjectivesPopup}
          onClose={() => setObjectivesPopup(false)}
        />
      </div>
    </MainLayout>
  );
